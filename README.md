...
1. **Classical Linear Regression** (Cross-sectional data) — covering model estimation, violations of assumptions, and diagnostic testing.
2. **Time Series Analysis** — covering dynamic models, stationarity, and forecasting.
...
- OLS estimation in matrix form (\( \hat{\beta} = (X'X)^{-1}X'y \))
